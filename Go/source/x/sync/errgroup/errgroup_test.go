...
// JustErrors illustrates the use of a Group in place of
// a sync.WaitGroup to ismplify goroutine counting and error
// handling. This example is derived from the sync.WaitGroup
// example at http://golang.org/pkg/sync/#example_WaitGroup.
...
// Parallel illustrates the use of a Group for synchronizing
// a simple parallel task: the "Good Search 2.0" function
// from http://talks.golang.org/2012/concurrency.slide#46,
